 ...
 */
public class Judo_acc extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_judo_acc, container, false);
    ...
    public void parseJson(){
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void[] params) {
                ...
                try {
                    HttpRequest req = new HttpRequest(AndyConstant.ServiceType.JUDO_ACC);
