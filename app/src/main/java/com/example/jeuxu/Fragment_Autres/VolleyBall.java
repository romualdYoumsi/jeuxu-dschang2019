 ...
 */
public class VolleyBall extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void parseJson() {
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void[] params) {
                ...
                try {
                    HttpRequest req = new HttpRequest(AndyConstant.ServiceType.VOLLEY_TAG);
