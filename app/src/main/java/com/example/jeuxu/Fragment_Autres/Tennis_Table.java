 ...
 */
public class Tennis_Table extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void parseJson() {
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void[] params) {
                ...
                try {
                    HttpRequest req = new HttpRequest(AndyConstant.ServiceType.TENNIS_TABLE_TAG);
